...
/**
 * NOTE by Hao Lin:
 * I modified the return of "public Socket createSocket(Socket socket, 
 * String host, int port,  boolean autoClose) throws IOException, 
 * UnknownHostException"  to avoid the following error
 *  "javax.net.ssl.SSLException: SSL handshake aborted: 
 *  ssl=0x2cb0e8: I/O error during system call. Broken Pipe"
 */
